...
import { useTakealotReturnsImportHistory } from '../../hooks/useReturns';
...
export function ReturnsImportHistory() {
  const { data: imports, isLoading } = useTakealotReturnsImportHistory();
  ...
  if (!imports || imports.length === 0) {
    return (
      <div className="rounded-xl border border-gray-200 bg-white p-12 text-center">
        ...
        <h3 className="mt-4 text-lg font-semibold text-gray-900">No Returns Export Imports Yet</h3>
        <p className="mt-2 text-sm text-gray-500">
          Upload your first Takealot Returns Export to track return reasons, customer comments, and stock outcomes.
        </p>
      </div>
    );
  }
